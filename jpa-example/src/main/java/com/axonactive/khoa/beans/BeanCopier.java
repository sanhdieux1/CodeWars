    ...
    public static <T> T in(Object source, T target) {
        ...
        try {
            ...
            for (Field targetField : targetFieldList) {
                ...
                if (mapped != null) {
                    FieldCopier fc = new FieldCopier(target, source, targetField, mapped, Direction.IN);
                    fc.handleProperty();
                }
            }
            return target;
    ...
    public static <T> T out(Object source, T target) {
        ...
        try {
            ...
            for (Field targetField : targetFieldList) {
                ...
                if (mapped != null) {
                    FieldCopier fc = new FieldCopier(source, target, targetField, mapped, Direction.OUT);
                    fc.handleProperty();
                }
            }
            return target;
